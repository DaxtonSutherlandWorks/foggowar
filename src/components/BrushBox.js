...
import BrushIcon from "../img/brushIcon.svg"
    ...
    return (
        <div className="tool-container">
            ...
            <div className="tool-sidebar">
                <button id="brush-button" onClick={handleOverlayDeactivation}>
                    <img src={BrushIcon} alt="" />
                    <span>Brushes</span>
                </button>
                <button id="stamp-button" onClick={handleStampOverlayActivation}>
